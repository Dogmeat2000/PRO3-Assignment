...
@Repository
public interface TrayToProductTransferRepository extends JpaRepository<TrayToProductTransferId, Long> // <-- Primary key of Entity must be provided as the Type to JpaRepository!
{
