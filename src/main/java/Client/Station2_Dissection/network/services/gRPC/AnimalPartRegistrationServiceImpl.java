...
import Client.common.model.adapters.gRPC_to_java.GrpcAnimalPartData_To_AnimalPartDto;
import Client.common.model.adapters.java_to_gRPC.AnimalPartDto_ToGrpc_AnimalPartData;
...
public class AnimalPartRegistrationServiceImpl extends GrpcConnection implements AnimalPartRegistrationService
{
  ...
  public AnimalPartRegistrationServiceImpl(String host, int port) {
    super(host, port);
  }
