...
public class TrayToProductTransfer
{
  ...
  @ManyToOne
  @JoinColumn(name = "tray_id", insertable = false, updatable = false, nullable = false) // Tells Spring Boot, that the designated column in the Tray entity should be used when joining tables. Additionally, the name of the column is 'tray_id' in both tables.
  ...
  // This makes logical sense, since it is from within this Tray Entity that references to the Tray are stored as Foreign Keys, and not in the Tray entity!
  @ManyToOne
  @JoinColumn(name = "product_id", insertable = false, updatable = false, nullable = false) // Tells Spring Boot, that the designated column in the Tray entity should be used when joining tables. Additionally, the name of the column is 'tray_id' in both tables.
  ...
  public TrayToProductTransferId getId() {
    return id;
  }

  public void setId(TrayToProductTransferId id) {
    this.id = id;
  }
  ...
  public void setTray(Tray tray) {
    this.tray = tray;
    getId().setTray_id(tray.getTray_id());
  ...
  public void setProduct(Product product) {
    this.product = product;
    getId().setProduct_id(product.getProduct_id());
