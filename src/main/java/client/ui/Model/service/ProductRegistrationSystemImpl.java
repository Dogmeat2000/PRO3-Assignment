...
public class ProductRegistrationSystemImpl extends Client implements ProductRegistrationSystem
{
  ...
  public ProductRegistrationSystemImpl(String host, int port, int maxNestingDepth) {
    super(host, port);
  ...
  public Product registerNewProduct(List<AnimalPart> animalPartContentList, List<Tray> receivedPartsFromTrayList) throws CreateFailedException {
    ...
    try {
      ...
      Product product = grpcProductDataConverter.convertToProduct(createdProduct, maxNestingDepth);
  ...
  public Product readProduct(long productId) throws NotFoundException {
    ...
    try {
      ...
      Product product = grpcProductDataConverter.convertToProduct(foundProduct, maxNestingDepth);
  ...
  public void updateProduct(Product data) throws UpdateFailedException, NotFoundException {
    ...
    try {
      ...
      ProductData product = Product_ToGrpc_ProductData.convertToProductData(data, maxNestingDepth);
  ...
  public boolean removeProduct(long productId) throws DeleteFailedException, NotFoundException {
    ...
    try {
      ...
      ProductData productData = Product_ToGrpc_ProductData.convertToProductData(product, maxNestingDepth);
  ...
  public List<Product> getAllProducts() throws NotFoundException {
    ...
    try {
      ...
      List<Product> products = grpcProductDataConverter.convertToProductList(productsData, maxNestingDepth);
