...
public class RecallMachineTest
{
  ...
  public void setUp() {
    ...
    animalPartRegistrationService = new AnimalPartRegistrationServiceImpl("localhost", 9090);
    productRegistrationSystem = new ProductRegistrationSystemImpl("localhost", 9090);
    animalRegistrationService = new AnimalRegistrationServiceImpl("localhost", 9090);
  ...
  public void testRetrieveRegistrationNumberForAllAnimalsInvolvedInAProduct() {
    ...
    List<AnimalPartDto> animalParts = animalPartRegistrationService.readAnimalPartsByProductId(productId);
  ...
  public void testRetrieveAllProductsAGivenAnimalIsInvolvedIn() {
    ...
    animalReceived = animalRegistrationService.readAnimal(animalId);

    // Retrieve a List of all AnimalPart_ids involved in this Animal:
    List<AnimalPartDto> animalParts = animalPartRegistrationService.readAnimalPartsByAnimalId(animalId);
