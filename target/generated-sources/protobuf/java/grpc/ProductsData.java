...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 2,
      /* suffix= */ "",
      ProductsData.class.getName());
  }
  // Use ProductsData.newBuilder() to construct.
  private ProductsData(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(grpc.ProductsData result) {
      if (productsBuilder_ == null) {
    ...
    private void buildPartial0(grpc.ProductsData result) {
